 ...
 */
class MenuItem extends \Model\MenuItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'label', 'url', 'itemOrder', 'hidden', 'menu', 'children', 'parent');
        }
    ...
    public function setItemOrder($order)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setItemOrder', array($order));

        return parent::setItemOrder($order);
    }
     ...
     * {@inheritDoc}
     */
    public function addChild(\Model\MenuItem $item)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addChild', array($item));
