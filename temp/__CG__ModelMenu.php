 ...
 */
class Menu extends \Model\Menu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'description', 'items', 'languages');
        }
     ...
     * {@inheritDoc}
     */
    public function addMenuItem(\Model\MenuItem $item)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addMenuItem', array($item));

        return parent::addMenuItem($item);
    }
