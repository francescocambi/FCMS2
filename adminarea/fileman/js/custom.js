...
function FileSelected(file){
  ...
  console.log("Marianna cane");
  var win = (window.opener?window.opener:window.parent);
  win.document.getElementById(RoxyUtils.GetUrlParam('input')).value = file.fullPath;
  //document.getElementById(RoxyUtils.GetUrlParam('input')).value = file.fullPath;
  var dialogid = RoxyUtils.GetUrlParam('dialogid');
